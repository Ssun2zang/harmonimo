            ...
            children: [
              ...
              Container(
                ...
                child: TextField(
                    ...
                    onChanged: (value) {},
                    decoration: InputDecoration(border: OutlineInputBorder(),labelText: '사용자 이름',labelStyle: TextStyle(color: Colors.black,fontSize: 20,fontWeight: FontWeight.w600),
              ...
              Container(
                ...
                child: TextField(
                    ...
                    onChanged: (value) {},
                    decoration: InputDecoration(border: OutlineInputBorder(),labelText: '닉네임',labelStyle: TextStyle(color: Colors.black,fontSize: 20,fontWeight: FontWeight.w600),
                      suffixIcon: GestureDetector(
                        child: Icon(
                          Icons.cancel,
                          color: Colors.grey,
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: TextField(
                        ...
                        controller: _age,
                        onChanged: (value) {},
                        decoration: InputDecoration(border: OutlineInputBorder(),labelText: '나이',labelStyle: TextStyle(color: Colors.black,fontSize: 20,fontWeight: FontWeight.w600),
                          suffixIcon: GestureDetector(
                            child: Icon(
                              Icons.cancel,
                              color: Colors.grey,
              ...
              ElevatedButton(onPressed: () async {
                try{
                  ...
                  print(_username.text+_nickname.text);
                  print(gender);
                  print(age);
                  print(id);
                  print(pw);
                  ...
                  if(_username.text!=null&&_nickname.text!=null&&age!=0){
                    ...
                    ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Text("필수 정보를 모두 입력하세요.")));
                  }
